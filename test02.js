...
//Question 1.2
//Find the errors in the following conditional:
if (true) {
  console.log("hello")
} else{
...
//Write a sentence that uses the following variables
 var totalPower = 32
 var generator = 1
// generator  +  "  tiene la fuerza de  " + totalPower
...
if (currentPool <= 7) {
totalVolume+= 1000
console.log("la piscina #"+currentPool+" esta llena para un total de "+totalVolume+" galones")
}else{
totalVolume+= 3000
console.log("la piscina #"+currentPool+" esta llena para un total de "+totalVolume+" galones")
}
